...
public abstract class AUserEntity extends AEntity {
    ...
    public void addRole(String role) {
        if (!this.getRoles().contains(role)) this.setRoles(this.getRoles().concat(",").concat(role));
    }

    public void removeRole(String role) {
        if (this.getRoles().contains(role)) this.setRoles(this.getRoles().replace("," + role, ""));
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AUserEntity)) return false;
