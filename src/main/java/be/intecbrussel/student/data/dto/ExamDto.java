...
public class ExamDto extends ADto {
    ...
    public void setStudentId(String studentId) {
        this.setStudent(new StudentDto().withId(studentId));
    }
    ...
    public ExamDto withStudentId(String studentId) {
        this.setStudent((StudentDto) new StudentDto().withId(studentId));
        return this;
    }

    public ExamDto withStudent(StudentDto student) {
